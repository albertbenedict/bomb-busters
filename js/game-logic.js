...
export const MISSIONS = [
  {
    id: 1,
    name: "Mission 1 - Intro",
    desc: "The intro mission — just enough yellow to learn the group-guess, one red to respect.",
    longDesc: "Welcome to the bomb. Two yellows (1.1-style) share one guess key — cut any yellow with “Yellow”. One red (1.5-style) ends the game if guessed. Use your single blue hint to anchor a number, then watch the wire tracker: every cut shows how many of that value remain. Play slow, learn the decimal interleaving.",
    yellowCount: 2,
    redCount: 1,
    hintsEnabled: true,
  },
  {
    id: 2,
    name: "Mission 2 - Yellow Alert",
    desc: "More yellows in the line means more positions to track — deduction starts to matter.",
    longDesc: "Four yellows crowd the line between the blues. You’ll see more 1.1, 2.1… gaps in the tracker between numbers. Hints are still on, but you’ll need to remember which yellows have been revealed and which 1.1s are still hidden. Start counting positions, not just values.",
    yellowCount: 4,
    redCount: 1,
    hintsEnabled: true,
  },
  {
    id: 3,
    name: "Mission 3 - Wire and Fire",
    desc: "A second red wire in play — one wrong guess in the wrong place now ends it.",
    longDesc: "Two reds (1.5-style) now hide between the blues. Any red guess is instant loss, and any wrong blue guess still ticks the detonator toward the skull. With four yellows, the line is dense — use the tracker gaps (yellow and red dots between numbers) and the per-wire houses to separate 3, 3.1 and 3.5 before you guess.",
    yellowCount: 4,
    redCount: 2,
    hintsEnabled: true,
  },
  {
    id: 4,
    name: "Mission 4 - Steady Hands",
    desc: "Maximum yellow, and the team's one free clue is gone — everything now comes from cuts and wrong-guess reveals.",
    longDesc: "Six yellows, two reds, no starting hints. The only information now comes from cuts and the “was” houses left after wrong guesses. The equipment still unlocks after 4 of a value — time it to defuse a mistake or skip a dangerous turn. Communication is only the tracker and your cuts.",
    yellowCount: 6,
    redCount: 2,
    hintsEnabled: false,
  },
  {
    id: 5,
    name: "Mission 5 - No Second Chances",
    desc: "The hardest config this system supports — max yellow, max red, no starting information at all.",
    longDesc: "Six yellows, three reds, no hints. Every decimal matters, every red could be the last wire. You’ll need to solo-cut when you hold all remaining of a value, and know when to use Blue/Yellow hint equipment to reveal a single wire’s colour. One wrong red guess ends it — steady hands, clear calls.",
    yellowCount: 6,
    redCount: 3,
    hintsEnabled: false,
  },
